...
- **2 Jokers** (red + black): a joker beats any card of its own colour. Play a joker on
  one card, then press **Finish** — the bout ends and any remaining undefended cards are
  pushed to the player before you.
